        ...
        <main className="w-full text-center flex-grow flex flex-col items-center justify-center">
            ...
            >
                <motion.h1 
                  ...
                  className="text-4xl md:text-6xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-purple"
                >
                ...
                <motion.p 
                  variants={itemVariants}
                  className="mt-3 text-lg md:text-xl text-gray-600 dark:text-subtle-text"
                >
                  Upload your resume for an intelligent analysis of your professional journey.
                </motion.p>
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center text-center transition-transform duration-300 group-hover:scale-105">
                            ...
                            <p className="text-gray-500 dark:text-subtle-text mt-1">Click or drag & drop (PDF, TXT)</p>
                        </div>
                    </div>
