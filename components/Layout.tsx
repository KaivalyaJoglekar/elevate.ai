...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  const blobs = [
    // Left side
    { class: 'w-[30rem] h-[30rem] bg-red-500 opacity-20 dark:opacity-10', animate: { x: [0, 50, -20, 0], y: [0, -30, 60, 0] }, transition: { duration: 40, repeat: Infinity, repeatType: 'mirror', ease: 'easeInOut' } },
    { class: 'w-[35rem] h-[35rem] bg-brand-blue opacity-15 dark:opacity-5', animate: { x: [0, -40, 30, 0], y: [0, 60, -40, 0] }, transition: { duration: 50, repeat: Infinity, repeatType: 'mirror', ease: 'easeInOut' } },
    { class: 'w-[25rem] h-[25rem] bg-brand-purple opacity-20 dark:opacity-10', animate: { x: [0, 30, -60, 0], y: [0, 40, -20, 0] }, transition: { duration: 45, repeat: Infinity, repeatType: 'mirror', ease: 'easeInOut' } },
    // Right side
    { class: 'w-[30rem] h-[30rem] bg-sky-400 opacity-20 dark:opacity-10', animate: { x: [0, -50, 20, 0], y: [0, 30, -60, 0] }, transition: { duration: 42, repeat: Infinity, repeatType: 'mirror', ease: 'easeInOut' } },
    { class: 'w-[35rem] h-[35rem] bg-pink-500 opacity-15 dark:opacity-5', animate: { x: [0, 40, -30, 0], y: [0, -60, 40, 0] }, transition: { duration: 52, repeat: Infinity, repeatType: 'mirror', ease: 'easeInOut' } },
    { class: 'w-[25rem] h-[25rem] bg-violet-500 opacity-20 dark:opacity-10', animate: { x: [0, -30, 60, 0], y: [0, -40, 20, 0] }, transition: { duration: 48, repeat: Infinity, repeatType: 'mirror', ease: 'easeInOut' } },
  ];
