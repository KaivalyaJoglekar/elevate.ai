...
function useCircularParticleTexture() {
  return useMemo(() => {
    const size = 64;
...
function FloatingParticles() {
  ...
  const circleTexture = useCircularParticleTexture();
...
export const ElevatedGridBackground = () => {
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 z-0">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-[0.06] pointer-events-none z-10">
        <div
      ...
      <div
        className="absolute inset-0 opacity-[0.02] pointer-events-none z-20 mix-blend-overlay"
        style={{
